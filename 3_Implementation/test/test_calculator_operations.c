...
void test_temp_C_F2(void);
void test_temp_F_C2(void);
void test_Len_M_F2(void);
void test_Len_F_M2 (void);
void test_current_DC_AC2(void);
void test_current_AC_DC2(void);

void test_temp_F_C3(void);
...
/* Run Test functions */
  ...
  RUN_TEST(test_temp_C_F2);
  RUN_TEST(test_temp_F_C2);
  RUN_TEST(test_Len_M_F2);
  RUN_TEST(test_Len_F_M2);
  RUN_TEST(test_current_DC_AC2);
  RUN_TEST(test_current_AC_DC2);
  
  RUN_TEST(test_temp_F_C3);
